...
const HoverButton = ({ text }) => {
  return (
    <button className="relative w-40 h-12 flex items-center justify-center bg-[#EE5023] text-white font-semibold transition-all duration-300 group overflow-hidden border-2 border-transparent hover:border-white">
